            ...
            <div className="max-w-6xl mx-auto p-4 space-y-4 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 py-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <div className="flex items-center">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d561.1501475396168!2d-66.82522768352437!3d10.493514491899063!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c2a590072e9c66b%3A0xc89409db48c9189f!2sCentro%20de%20Capacitaci%C3%B3n%20Laboral%20Barrios%20unidos%20de%20Petare!5e1!3m2!1ses-419!2sus!4v1730515293680!5m2!1ses-419!2sus" className='md:w-[600px] md:h-[450px] max-md:h-[400px] max-md:h-[250px] b-0 rounded-md' allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                            </div>
                        </div>
                    </div>
                </div>
