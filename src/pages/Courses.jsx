...
export default function Cursos() {
    ...
    return (
        <div>
            <Header />
            <div className="max-w-6xl max-md:py-20 mx-auto p-4 space-y-4 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <h1 className="text-4xl max-md:text-3xl max-md:w-[70%] md:w-[40%] font-bold text-center mb-12 border-b-2 pb-4  border-blue mx-auto max-sm:text-2xl">Nuestros Cursos</h1>
