        ...
        <div>
            ...
            <div className="max-w-6xl mx-auto max-md:py-20 p-4 space-y-4 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <h1 className="text-4xl max-md:text-3xl max-md:w-fit md:w-[40%] font-bold text-center mb-12 border-b-2 pb-4 w-[30%] border-blue mx-auto max-sm:text-2xl">Quiénes Somos</h1>

                    <div className="mb-16">
                        <h2 className="text-2xl font-semibold mb-4 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue max-sm:text-xl">Nuestra Historia</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold mb-4 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue max-sm:text-xl">Nuestra Misión</h2>
                        <p className="text-gray-700 mb-4">
                        ...
                        <h2 className="text-2xl font-semibold mb-4 mt-8 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue max-sm:text-xl">Nuestra Visión</h2>
                        ...
                        <h2 className="text-2xl font-semibold mb-4 mt-8 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue max-sm:text-xl">Nuestros Valores</h2>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid md:grid-cols-2   w-full max-md:grid-cols-1  gap-8 mb-8">
                            <div className="bg-white p-6 max-md:w-full rounded-lg  shadow-md shadow-[#b4b4b4] items-center flex flex-col">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-balance text-center">Inspectoría Salesiana San Lucas</h3>
                            ...
                            <div className="bg-white p-6   max-md:w-full rounded-lg py-4 text-balance shadow-md shadow-[#b4b4b4] items-center flex flex-col">
                                <img loading='lazy' src={AVEC} alt="Asociación Venezolana de Educación Católica AVEC" className="h-24 w-24 text-blue mb-4" />
                                <h3 className="text-xl font-semibold mb-2 text-balance text-center">Asociación Venezolana de Educación Católica AVEC</h3>
