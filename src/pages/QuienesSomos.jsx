        ...
        <div>
            ...
            <div className="max-w-6xl mx-auto p-4 space-y-4 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <h1 className="text-4xl max-md:text-3xl max-md:w-fit md:w-[40%] font-bold text-center mb-12 border-b-2 pb-6 w-[30%] border-blue mx-auto">Quiénes Somos</h1>

                    <div className="mb-16">
                        <h2 className="text-2xl font-semibold mb-4 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue">Nuestra Historia</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold mb-4 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue">Nuestra Misión</h2>
                        <p className="text-gray-700 mb-4">
                        ...
                        <h2 className="text-2xl font-semibold mb-4 mt-8 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue">Nuestra Visión</h2>
                        ...
                        <h2 className="text-2xl font-semibold mb-4 mt-8 border-b-2 pb-2 md:w-[20%] max-md:w-fit border-blue">Nuestros Valores</h2>
                    ...
                    <div className="mt-8">
                        <h2 className="text-2xl font-semibold mb-8 border-b-2 pb-2 md:w-[25%] py-4 max-md:w-fit border-blue">Instituciones aliadas</h2>
